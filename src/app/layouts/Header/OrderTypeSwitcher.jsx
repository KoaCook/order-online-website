            ...
            anchor={
                <div className="h-11 border border-solid border-[#dbdbdb] px-4 w-[200px] flex items-center justify-between rounded-md cursor-pointer">
                    <div className="flex-1 flex ">
                        ...
                        <span className="ml-3.5">Giao hàng</span>
                    </div>
                    <ChevronDown size={12} />
                </div>
            }
            ...
            <div className="absolute shadow-menu left-0 top-0 right-0 bg-white py-2 rounded-md">
                <ul>
                    ...
                    >
                        ...
                        <div className="ml-2 text-sm">Giao hàng</div>
                    </li>
                    <li
                        role="button"
                        tabIndex={0}
                    ...
                    >
                        ...
                        <div className="ml-2 text-sm">Tự đến lấy</div>
                    </li>
                    <li
                        role="button"
                        tabIndex={0}
                    ...
                    >
                        ...
                        <div className="ml-2 text-sm">Đặt chỗ online</div>
                    </li>
                </ul>
            </div>
        </Menu>
